...
then
    ...
    cd glog-0.3.3;
    _mlog "build glog";
    ./configure --with-gflags=${DIR_3rdparty}/gflags/build;
    make;
    ## make && make install;
    _mlog "done glog";
    ##
    ...
    ##
    mkdir include;
    for d in "${DIR_3rdparty}/gflags/build/include" "${DIR_3rdparty}/mdb/libraries/liblmdb" "${DIR_3rdparty}/glog-0.3.3/src";
    do
	ln -s $d/* include;
    done
    ##
